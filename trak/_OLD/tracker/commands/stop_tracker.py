...
from trak._OLD.database import get_running_session, stop_trak_session
from trak.models import Record
from trak.utils.base_messages import print_error, print_info, print_success
...
def stop_tracker():
    ...
    if not isinstance(stopped_record, Record):
        print_error(
    ...
    print_success(title="⏹️ Stop", text=output_text)
